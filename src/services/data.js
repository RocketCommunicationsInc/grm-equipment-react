import { uniqueInt, randInt } from '../util/util';
...
export let mainData = [
  {
    ...
    label: 'Comms',
    payload: null,
    children: generateComponents(randInt(2, 5), 'Equipment E', 4),
  },
  {
    id: 'digital',
    label: 'Digital',
    payload: null,
    children: generateComponents(randInt(2, 5), 'Equipment E', 3),
  },
  {
    id: 'facilities',
    label: 'Facilities',
    payload: null,
    children: generateComponents(randInt(2, 5), 'Equipment E', 5),
  },
  {
    id: 'rf',
    label: 'RF',
